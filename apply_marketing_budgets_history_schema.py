"""Allow audited editing and deletion in the marketing budget registry."""
...
def main() -> None:
    env = load_env(".env")
    sql = Path("marketing_budgets_history_schema.sql").read_text(
        encoding="utf-8"
    )
    ...
    try:
        ...
        connection.close()
    print("Marketing budget history schema is ready")
