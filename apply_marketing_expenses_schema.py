"""Apply the non-destructive marketing expense schema migration."""
...
def main() -> None:
    env = load_env(".env")
    sql = Path("marketing_expenses_schema.sql").read_text(encoding="utf-8")
    ...
    try:
        ...
        connection.close()
    print("Marketing expense schema is ready")
